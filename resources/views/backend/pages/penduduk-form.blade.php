  ...
  <div class="section-body">
    <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
          <form action="{{ $form == 'create' ? route('penduduk.store') : route('penduduk.update', $item->nik) }}"
            ...
            <div class="card-body row pb-0">
              <div class="form-group col-md-4">
                <label>Nama</label>
                <input type="text" name="name" id="name" class="form-control @error('tanggal_lahir')is-invalid @enderror"
              ...
              <div class="form-group col-md-4">
                ...
                <input type="number" name="nik" id="nik" class="form-control"
                  value="{{ isset($item->nik) ? $item->nik : old('nik') }}">
                @error('nik')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="number" name="nomor_kk" id="nomor_kk" class="form-control"
              ...
              <div class="form-group col-md-8">
                ...
                <input type="number" name="alamat" id="alamat" class="form-control"
                  value="{{ isset($item->alamat) ? $item->alamat : old('alamat') }}">
                @error('alamat')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-2">
                ...
                <input type="number" name="rt" id="rt" class="form-control"
                  value="{{ isset($item->rt) ? $item->rt : old('rt') }}">
                @error('rt')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-2">
                ...
                <input type="number" name="rw" id="rw" class="form-control"
                  value="{{ isset($item->rw) ? $item->rw : old('rw') }}">
                @error('rw')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="agama" id="agama" class="form-control"
                  value="{{ isset($item->agama) ? $item->agama : old('agama') }}">
                @error('agama')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="text" name="pendidikan" id="pendidikan" class="form-control"
                  value="{{ isset($item->pendidikan) ? $item->pendidikan : old('pendidikan') }}">
                @error('pendidikan')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="text" name="pekerjaan" id="pekerjaan" class="form-control"
                  value="{{ isset($item->pekerjaan) ? $item->pekerjaan : old('pekerjaan') }}">
                @error('pekerjaan')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="text" name="golongan_darah" id="golongan_darah" class="form-control"
                  value="{{ isset($item->golongan_darah) ? $item->golongan_darah : old('golongan_darah') }}">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="status_keluarga" id="status_keluarga" class="form-control"
                  value="{{ isset($item->status_keluarga) ? $item->status_keluarga : old('status_keluarga') }}">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="status_perkawinan" id="status_perkawinan" class="form-control"
                  value="{{ isset($item->status_perkawinan) ? $item->status_perkawinan : old('status_perkawinan') }}">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="kewarganegaraan" id="kewarganegaraan" class="form-control"
                  value="{{ isset($item->kewarganegaraan) ? $item->kewarganegaraan : old('kewarganegaraan') }}">
